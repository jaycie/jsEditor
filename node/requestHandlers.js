                       ...
                       var _subStart = data.indexOf('packetSetting:{"tplId":"')
                        if(_subStart>0){  //写入抢红包第二个页面
                            ...
                            if(parseInt(packetTplId)>0){
                                ...
                                var newData= data.replace('<a href="#nolink" id="grabBonus">','<div class="show-ajax-data"><span class="data-get"></span><span class="data-share"></span><a href="#nolink" class="show-detail"></a>')
